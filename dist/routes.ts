...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { NewslettersController } from './../src/controllers/newsletterController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { ReadSiteController } from './../src/controllers/readSiteController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { SubscribersController } from './../src/controllers/subscriberController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { WrtieSiteController } from './../src/controllers/writeSiteController';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/newsletter',
            ...
            function NewslettersController_sendAllNewsletters(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.sendAllNewsletters.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/comments',
            ...
            function ReadSiteController_createSite(request: any, response: any, next: any) {
            const args = {
            ...
            try {
                ...
                const controller = new ReadSiteController();
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/subscribers/:siteId',

            function SubscribersController_signupSubscriber(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.signupSubscriber.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/subscribers/:siteId',

            function SubscribersController_signdownSubscriber(request: any, response: any, next: any) {
            const args = {
                    siteId: {"in":"path","name":"siteId","required":true,"dataType":"string"},
            ...
            try {
              ...
              const promise = controller.signdownSubscriber.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/write',
            ...
            function WrtieSiteController_createSite(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
            ...
            try {
                ...
                const controller = new WrtieSiteController();
